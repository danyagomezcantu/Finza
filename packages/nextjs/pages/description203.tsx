...
const Description203: NextPage = () => {
  ...
  return (
    <div className="relative bg-studio-darkmode-allwhite-ffffff w-full h-[1808px]">
      <Footer footerTop="1618px" />
