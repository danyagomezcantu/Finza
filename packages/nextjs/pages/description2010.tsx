...
const Description2010: NextPage = () => {
  ...
  return (
    <div className="relative bg-studio-darkmode-allwhite-ffffff w-full h-[1810px]">
      ...
      <div className="absolute top-[93px] left-[calc(50%_-_960px)] w-[1920px] h-[1527px]">
        ...
        <section className="absolute top-[609px] left-[calc(50%_-_866px)] w-[1732px] h-[916px] overflow-hidden text-left text-13xl text-studio-darkmode-allwhite-ffffff font-components-button-large">
          ...
          <div className="absolute top-[36px] left-[0px] tracking-[0.13px] leading-[40px] text-black inline-block w-[1071px] h-[728px] text-29xl">
            ...
            <p className="m-0 text-5xl">
              <span className="font-light">
                <span>
                  Welcome to your dream coastal retreat! Nestled in a
                  prestigious gated community with breathtaking views of the
                  Gulf of Mexico, this magnificent home offers the epitome of
                  luxury living. With 8 bedrooms, 8 bathrooms, and 2 half baths,
                  this expansive estate provides an abundance of space for
                  family, friends, and guests.As you enter the property, you'll
                  be greeted by lush landscaping that sets the tone for the
                  elegance that awaits. The main house boasts a seamless blend
                  of contemporary design and coastal charm, with soaring
                  ceilings, large windows, and an open floor plan that allows
                  natural light to flood every corner. The gourmet kitchen is a
                  chef's delight, featuring top-of-the-line appliances, a
                  spacious island, and ample storage.
                </span>
              </span>
            </p>
          </div>
...
export default Description2010;
